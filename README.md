...
_**LATEST NEWS**  
• macOS Tahoe on more Unsupported Macs: [Experimental OCLP T2 (albert-mueller)](https://www.youtube.com/watch?v=8gJl0FMgYbE#t=3m27s)  
• Jessie's Flying Benchmark videos: [Did macOS Tahoe kill official OCLP 3.0 support? NO!](https://www.youtube.com/watch?v=MBnKT_ga3Ss&list=PLHL6IcL-qTheCdZSWluPmSfSg6FbqVnGj&index=1)  
...
<img src="images/Monterey.png" width="395"/> <img src="images/Windows11.png" width="395"/>  
<img src="images/P2M19.png" width="395"/>  <img src="images/BootPicker.png" width="395"/>  
...
• IntelBTPatcher.kext<sup>_1_</sup> ........................ 2.5.1<sub>_patch_</sub>  
• IntelBluetoothFirmware.kext<sup>_1_</sup> .......... 2.5.1<sub>_patch_</sub> _........ [experimental fork v2.5.1 (lshbluesky)](https://github.com/lshbluesky/IntelBluetoothFirmware)_    
• IntelBluetoothInjector.kext<sup>_1_</sup> ............. 2.5.1<sub>_patch_</sub> _........ for macOS 11 or earlier ....................... 20.9.9_  
...
• Sleep / Wake  
• TouchPad  
• TouchScreen : _fixed by [@gargamel788](https://github.com/gargamel778)_    
• USB and USB Mapping  
• Volume control  
...
## What doesn't work  
• Fingerprint Sensor  
• HDMI video/audio: _Hot-plug the HDMI cable<sup>_6_</sup> or use a **USB-C to HDMI Cable/Adapter** with PD_  
...
_1. The latest [_GPD P2Max Windows10 Home v1909 firmware_](https://gpd.hk/gpdp2maxfirmwaredriverbios)<sup>_7_</sup> restores the factory Out-Of-Box-Experience:_  
...
## Enabling native Intel WiFi/BT/Audio on macos Tahoe & Sequoia:  
_⚠️ **NOTE:** Ensure that you're connected to the internet, as OCLP may need to download additional files._  

_1• **†Sonoma / †Monterey / †BigSur**:  No Root Patches required._  
...
_Revert Root Patches and **uninstall** current experimental OpenCore Legacy Patcher in Tahoe. Reboot._  
_Install experimental [OCLP 3.0.0 Nightly (kgp-macPro)](https://github.com/kgp-macPro/OCLP-lzhoang2801-amfipassbeta) and re-apply Root Patches. Reboot and reset NVRAM._  
<img src="images/rootpatch2.png" height="300"/>  

_or **Tahoe** (with the use of EFI/OC/config-itlwm-heliport.plist)<sup>_5_</sup>:_  
_Revert Root Patches and **uninstall** current experimental OpenCore Legacy Patcher in Tahoe. Reboot._  
_Install official [HeliPort v2.3.0)](https://github.com/OpenIntelWireless/itlwm) . Reboot and reset NVRAM._  
_Add HeliPort.app in SystemSettings > General > Open at Login._


## Notes
• **Configure Hibernation<sup>_8_</sup>**   
_⚠️ **NOT TESTED:** Open Terminal and enter the following commands, to enable hibernatemode 25 (= Hibernation).  
If you don't want to use Hibernation, use hibernatemode 3 (= reguar S3 Sleep) instead:_  
...
Special thanks go to [**@gargamel788**](https://github.com/gargamel778) and [**@lazd**](https://github.com/lazd/VoodooI2CGoodix), who made the Goodix GT928 TouchScreen fully working in macOS Sonoma, Sequoia and Tahoe  
Thanks to [**@muhamadahmadbzu**](https://github.com/muhamadahmadbzu), who kindly shared his solution for the iGPU hardware acceleration<sup>_4_</sup>  
...
_<sup>8</sup> https://github.com/5T33Z0/Thinkpad-T490-Hackintosh-OpenCore#configure-hibernation_  


_**[SOLVED] Native Intel WiFi/BT/Audio on macOS Tahoe & Sequoia | Step By Step Video-Guide.**_  
_<sup>1</sup> https://github.com/OpenIntelWireless/itlwm/issues/1062_  
_<sup>1</sup> https://github.com/OpenIntelWireless/IntelBluetoothFirmware/issues/505#issuecomment-4852052902_  
_<sup>1</sup> [https://openintelwireless.github.io/IntelBluetoothFirmware/FAQ.html#...to make bluetooth-work-on-macos-monterey-and-newer](https://openintelwireless.github.io/IntelBluetoothFirmware/FAQ.html#what-additional-steps-should-i-do-to-make-bluetooth-work-on-macos-monterey-and-newer)_  
...
_**[EXPLAINED] Have to Hot-plug HDMI cable to connect to external monitor.**_  
